...
Single commit `bc004b3` — *"chore: modernize UI5 TypeScript app (config, async component, typings, deprecated bootstrap params)"* — 11 files changed (+111 / −69). Files staged explicitly; nothing pushed.
